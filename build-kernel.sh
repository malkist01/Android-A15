...
#
# Copyright (C) 2025 Teletubies Kernel
#
...
export KBUILD_BUILD_HOST="windows-android"
export KBUILD_BUILD_TIMESTAMP="$(TZ='Asia/Jakarta' date)"

CHANNEL_ID="-1002287610863"
TELEGRAM_TOKEN="7596553794:AAGoeg4VypmUfBqfUML5VWt5mjivN5-3ah8"
...
git clone -b clang-20.0 --depth=1 https://gitlab.com/kutemeikito/rastamod69-clang.git ${TC_PATH}
